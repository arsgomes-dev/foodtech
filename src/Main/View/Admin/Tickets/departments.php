...
<html lang="pt-br" style="height: auto;">
    ...
    <body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" style="height: auto;">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content col-lg-8 offset-lg-2 col-md-12 offset-md-0">
                    ...
                    echo $baseHtml->baseBreadcrumb($translate->translate("Ticket - Departamentos", $_SESSION['user_lang']), $directory, $translate->translate("Departamentos", $_SESSION['user_lang']));
                    ?>  
                    ...
                    if (in_array("ticket_department_view", $privilege_types)) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-12 d-flex flex-column justify-content-center">
                                ...
                                if (in_array("ticket_department_create", $privilege_types)) {
                                    ?>
                                    <button aria-label="Close" type="button" class="btn btn-block btn-success btn-color" title="<?php echo $translate->translate('Adicionar departamento', $_SESSION['user_lang']); ?>" data-toggle="modal" data-target=".addDepartment">
                                        <i class="fa fa-plus"></i> <?php echo $translate->translate('Adicionar departamento', $_SESSION['user_lang']); ?>
                                    </button>
                                <?php } ?>
                            </div>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">                                                
                                        ...
                                        <div class="card card-outline">
                                            ...
                                            <!-- /.card-header -->
                                            <div class="card-body" style="display: block;">
                                                <input type="text" id="description_search" name="description_search" class="form-control form-control-md" placeholder="<?php echo $translate->translate('Departamento', $_SESSION['user_lang']); ?>">
                                            </div>
                                            <!-- /.card-body -->
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-primary" onclick="loadBtnDepartments();"><?php echo $translate->translate('Filtrar', $_SESSION['user_lang']); ?></button>
                        ...
                        if (in_array("ticket_department_create", $privilege_types)) {
                            ?>
                            <!-- Modal -->
                            <div class="modal fade addDepartment" id="" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="form-group to_validation">
                                                            ...
                                                            <input type="text" class="form-control to_validations" id="title_department" name="title" placeholder="<?php echo $translate->translate('Departamento', $_SESSION['user_lang']); ?>">
                                                            <div id="to_validation_blank_title_department" style="display: none;" class="to_blank"><span><?php echo $translate->translate('Não é permitido campo em branco', $_SESSION['user_lang']); ?>!</span></div>
                                                        </div>
                                                        <div class="form-group to_validation">
                                                            <label for="status"><?php echo $translate->translate('Status', $_SESSION['user_lang']); ?> *</label>
                                                            <select class="custom-select to_validations" id="status_department" name="status">
                                                                <option value=""><?php echo $translate->translate('Selecione', $_SESSION['user_lang']); ?>...</option>
                                                            ...
                                                            <div id="to_validation_blank_status_department" style="display: none;" class="to_blank"><span><?php echo $translate->translate('Selecione uma opção', $_SESSION['user_lang']); ?>!</span></div>
                                                        </div>
                                                    </div>
                                                </div>  
                                            </form>
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default btn-register" onclick="createDepartment(form_department);"><?php echo $translate->translate('Cadastrar', $_SESSION['user_lang']); ?></button>
                                            <button type="button" class="btn btn-default btn-cancel" data-dismiss="modal" onclick="cleanForm(form_department);"><?php echo $translate->translate('Cancelar', $_SESSION['user_lang']); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        if (in_array("ticket_department_view", $privilege_types)) {
            ?>
            <script src="<?php echo $config->getDomainAdmin(); ?>/libs/v1/admin/js/general/tickets/lists/ticket_department.js"></script>
        ...
        if (in_array("ticket_department_create", $privilege_types)) {
            ...
            <script src="<?php echo $config->getDomainAdmin(); ?>/libs/v1/admin/js/general/tickets/create/ticket_department.js"></script>
