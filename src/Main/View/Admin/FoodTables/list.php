...
use Microfw\Src\Main\Common\Entity\FoodTable;
use Microfw\Src\Main\Functions\Translate;

$translate = new Translate();

$config = new McConfig();
$foodSearch = new FoodTable;
$foods = new FoodTable;
    ...
    <table class="table table-striped">
        <thead>
            <tr>
                ...
                <th>
                    <font style="vertical-align: inherit;"><?php echo $translate->translate('Tabela', $_SESSION['user_lang']); ?></font>
                </th>
                <th>
                    <font style="vertical-align: inherit;"></font>
                </th>
        ...
        <tbody>
            ...
            if ($foodsCount > 0) {
                ...
                for ($i = 0; $i < $foodsCount; $i++) {
                    ...
                    ?>
                          <td style='vertical-align:middle !important'><a href='javascript:table_edit(<?php echo $food->getId(); ?>, "<?php echo $food->getDescription(); ?>");'>
