...
<html lang="pt-br" style="height: auto;">
    ...
    <body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" style="height: auto;">
        <div class="wrapper">
            <?php
            $baseHtml->baseMenu("foods", "groups");
            ?>
            <div class="content-wrapper" style="min-height: auto !important;">
                <section class="content col-lg-8 offset-lg-2 col-md-12 offset-md-0">
                    ...
                    $directory = [];
                    $directory["Home"] = "home";
                    echo $baseHtml->baseBreadcrumb($translate->translate("Grupo de Alimentos", $_SESSION['user_lang']), $directory, $translate->translate("Grupo de Alimentos", $_SESSION['user_lang']));
                    ?>  
                    ...
                    if (in_array("food_group_view", $privilege_types)) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-12 d-flex flex-column justify-content-center">
                                <?php
                                if (in_array("food_group_create", $privilege_types)) {
                                    ?>
                                    <button aria-label="Close" type="button" class="btn btn-block btn-success btn-color" title="<?php echo $translate->translate('Adicionar Grupo', $_SESSION['user_lang']); ?>" data-toggle="modal" data-target=".group-create">
                                        <i class="fa fa-plus"></i> <?php echo $translate->translate('Adicionar Grupo', $_SESSION['user_lang']); ?>
                                    </button>
                                <?php } ?>
                            </div>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="overflow-y: auto;">     
                                        <div class="card card-outline">
                                            ...
                                            <div class="card-body" style="display: block;">
                                                <select class="form-control form-control-md" style="width: 100%;" name="ord" id="ord">
                                                    ...
                                                    <optgroup label="<?php echo $translate->translate('Grupo', $_SESSION['user_lang']); ?>">
                                        ...
                                        <div class="card card-outline">
                                            ...
                                            <!-- /.card-header -->
                                            <div class="card-body" style="display: block;">
                                                <input type="text" id="group_name_search" name="group_name_search" class="form-control form-control-md" placeholder="<?php echo $translate->translate('Grupo', $_SESSION['user_lang']); ?>">
                                            </div>
                                            <!-- /.card-body -->
                                        </div>           
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-primary" onclick="loadBtnGroups();"><?php echo $translate->translate('Filtrar', $_SESSION['user_lang']); ?></button>
                        ...
                        if (in_array("food_group_create", $privilege_types)) {
                            ?>
                            <div class="modal fade new-modal group-create" id="group-create" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel"><?php echo $translate->translate('Cadastrar', $_SESSION['user_lang']); ?></h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="cleanForm(form_group);">
                                                <span>&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form style="margin: 10px;" role="form" name="form_group" id="form_group">
                                                <div class="row">
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="form-group to_validation to_validation_description">
                                                            <label for="description"><?php echo $translate->translate('Grupo', $_SESSION['user_lang']); ?></label>
                                                            <input type="text" class="form-control to_validations" id="description" name="description" placeholder="<?php echo $translate->translate('Grupo', $_SESSION['user_lang']); ?>">
                                        ...
                                        <div class="modal-footer justify-content-between">       
                                            <button type="button" class="btn btn-default btn-register" onclick="createGroup(form_group);"><?php echo $translate->translate('Salvar', $_SESSION['user_lang']); ?></button>
                                            <button type="button" class="btn btn-default btn-cancel" data-dismiss="modal" onclick="cleanForm(form_group);"><?php echo $translate->translate('Cancelar', $_SESSION['user_lang']); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        ?>
                        <?php
                        if (in_array("food_group_edit", $privilege_types)) {
                            ?>
                            <div class="modal fade update-modal group-update" id="group-update" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel"><?php echo $translate->translate('Atualizar', $_SESSION['user_lang']); ?></h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="cleanForm(form_update_group);">
                                                <span>&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form style="margin: 10px;" role="form" name="form_update_group" id="form_update_group">
                                                <input type="hidden" id="code" name="code">
                                                <div class="row">
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="form-group to_validation to_validation_description">
                                                            <label for="description"><?php echo $translate->translate('Grupo', $_SESSION['user_lang']); ?></label>
                                                            <input type="text" class="form-control to_validations" id="description_edit" name="description" placeholder="<?php echo $translate->translate('Grupo', $_SESSION['user_lang']); ?>">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default btn-register" onclick="createGroup(form_update_group);"><?php echo $translate->translate('Salvar', $_SESSION['user_lang']); ?></button>
                                            <button type="button" class="btn btn-default btn-cancel" data-dismiss="modal" onclick="cleanForm(form_update_group);"><?php echo $translate->translate('Cancelar', $_SESSION['user_lang']); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        if (in_array("food_group_view", $privilege_types)) {
            ?>
            <script src="/libs/v1/admin/js/general/foodGroups/lists/foodGroups.js"></script>
            <?php
        }
        ?>
