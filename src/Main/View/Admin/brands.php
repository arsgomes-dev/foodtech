...
<html lang="pt-br" style="height: auto;">
    ...
    <body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" style="height: auto;">
        ...
        <div class="wrapper">
            <?php
            $baseHtml->baseMenu("foods", "brands");
            ?>
            <div class="content-wrapper" style="min-height: auto !important;">
                <section class="content col-lg-8 offset-lg-2 col-md-12 offset-md-0">
                    ...
                    $directory = [];
                    $directory["Home"] = "home";
                    echo $baseHtml->baseBreadcrumb($translate->translate("Marcas", $_SESSION['user_lang']), $directory, $translate->translate("Marcas", $_SESSION['user_lang']));
                    ?>  
                    ...
                    if (in_array("brand_view", $privilege_types)) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-12 d-flex flex-column justify-content-center">
                                <?php
                                if (in_array("brand_create", $privilege_types)) {
                                    ?>
                                    <button aria-label="Close" type="button" class="btn btn-block btn-success btn-color" title="<?php echo $translate->translate('Adicionar Marca', $_SESSION['user_lang']); ?>" data-toggle="modal" data-target=".brand-create">
                                        <i class="fa fa-plus"></i> <?php echo $translate->translate('Adicionar Marca', $_SESSION['user_lang']); ?>
                                    </button>
                                <?php } ?>
                            </div>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="overflow-y: auto;">     
                                        <div class="card card-outline">
                                            ...
                                            <div class="card-body" style="display: block;">
                                                <select class="form-control form-control-md" style="width: 100%;" name="ord" id="ord">
                                                    ...
                                                    <optgroup label="<?php echo $translate->translate('Marca', $_SESSION['user_lang']); ?>">
                                        ...
                                        <div class="card card-outline">
                                            ...
                                            <!-- /.card-header -->
                                            <div class="card-body" style="display: block;">
                                                <input type="text" id="brand_name_search" name="brand_name_search" class="form-control form-control-md" placeholder="<?php echo $translate->translate('Marca', $_SESSION['user_lang']); ?>">
                                            </div>
                                            <!-- /.card-body -->
                                        </div>     
                                        <div class="card card-outline">
                                            ...
                                            <div class="card-body" style="display: block;">
                                                <div class="icheck-success">
                                                    <input type="radio" id="status1" name="brand_status_search" value="1"/>
                                                ...
                                                <div class="icheck-danger" style="margin-top: 15px !important;">
                                                    <input type="radio" id="status2" name="brand_status_search" value="3"/>
                                                ...
                                                <div class="icheck-default" style="margin-top: 15px !important;">
                                                    <input type="radio" id="status3" name="brand_status_search" value="" checked/>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-primary" onclick="loadBtnBrands();"><?php echo $translate->translate('Filtrar', $_SESSION['user_lang']); ?></button>
                        ...
                        if (in_array("brand_create", $privilege_types)) {
                            ?>
                            <div class="modal fade new-modal brand-create" id="brand-create" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel"><?php echo $translate->translate('Cadastrar', $_SESSION['user_lang']); ?></h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="cleanForm(form_brand);">
                                                <span>&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form style="margin: 10px;" role="form" name="form_brand" id="form_brand">
                                                <div class="row">
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="form-group to_validation to_validation_description">
                                                            <label for="description"><?php echo $translate->translate('Marca', $_SESSION['user_lang']); ?></label>
                                                            <input type="text" class="form-control to_validations" id="description" name="description" placeholder="<?php echo $translate->translate('Marca', $_SESSION['user_lang']); ?>">
                                                    ...
                                                    <div class="col-lg-12 col-sm-12 to_validation">
                                                        <div class="form-group to_validation_status">
                                                            ...
                                                            <div id="to_validation_blank_status" style="display: none;" class="to_blank"><span><?php echo $translate->translate('Não é permitido campo em branco', $_SESSION['user_lang']); ?>!</span></div>
                                                        </div>
                                                    </div>
                                                </div>  
                                            </form>
                                        ...
                                        <div class="modal-footer justify-content-between">       
                                            <button type="button" class="btn btn-default btn-register" onclick="createBrands(form_brand);"><?php echo $translate->translate('Salvar', $_SESSION['user_lang']); ?></button>
                                            <button type="button" class="btn btn-default btn-cancel" data-dismiss="modal" onclick="cleanForm(form_brand);"><?php echo $translate->translate('Cancelar', $_SESSION['user_lang']); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        ?>
                        <?php
                        if (in_array("brand_edit", $privilege_types)) {
                            ?>
                            <div class="modal fade update-modal brand-update" id="brand-update" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel"><?php echo $translate->translate('Atualizar', $_SESSION['user_lang']); ?></h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="cleanForm(form_update_brand);">
                                                <span>&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form style="margin: 10px;" role="form" name="form_update_brand" id="form_update_brand">
                                                <input type="hidden" id="code" name="code">
                                                <div class="row">
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="form-group to_validation to_validation_description">
                                                            <label for="description"><?php echo $translate->translate('Marca', $_SESSION['user_lang']); ?></label>
                                                            <input type="text" class="form-control to_validations" id="description_edit" name="description" placeholder="<?php echo $translate->translate('Marca', $_SESSION['user_lang']); ?>">
                                                    ...
                                                    <div class="col-lg-12 col-sm-12 to_validation">
                                                        <div class="form-group to_validation_status">
                                                            <label for="status"><?php echo $translate->translate('Status', $_SESSION['user_lang']); ?></label>
                                                            <select class="custom-select to_validations" id="status_edit" name="status">
                                                                <option value="">Selecione...</option>
                                                                <option value="1">Ativo</option>
                                                                <option value="0">Inativo</option>
                                                            </select>
                                                            <div id="to_validation_blank_status_edit" style="display: none;" class="to_blank"><span><?php echo $translate->translate('Não é permitido campo em branco', $_SESSION['user_lang']); ?>!</span></div>
                                                        </div>
                                                    </div>
                                                </div>  
                                            </form>
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default btn-register" onclick="createBrands(form_update_brand);"><?php echo $translate->translate('Salvar', $_SESSION['user_lang']); ?></button>
                                            <button type="button" class="btn btn-default btn-cancel" data-dismiss="modal" onclick="cleanForm(form_update_brand);"><?php echo $translate->translate('Cancelar', $_SESSION['user_lang']); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <?php
        if (in_array("brand_create", $privilege_types) || in_array("brand_edir", $privilege_types)) {
            ?>
        ...
        if (in_array("brand_view", $privilege_types)) {
            ?>
            <script src="/libs/v1/admin/js/general/brands/lists/brands.js"></script>
            <?php
        }
        ?>
