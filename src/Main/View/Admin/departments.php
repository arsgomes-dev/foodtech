...
<html lang="pt-br" style="height: auto;">
    ...
    <body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" style="height: auto;">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content col-lg-8 offset-lg-2 col-md-12 offset-md-0">
                    ...
                    echo $baseHtml->baseBreadcrumb($translate->translate('Departamentos', $_SESSION['user_lang']), $directory, $translate->translate('Departamentos', $_SESSION['user_lang']));
                    ?>  
                    ...
                    if (in_array("department_view", $privilege_types)) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-12 d-flex flex-column justify-content-center">
                                <?php
                                if (in_array("department_create", $privilege_types)) {
                                    ?>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="cleanForm(form_department);">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-sm-12 to_validation">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control to_validations" id="title"  name="title" placeholder="<?php echo $translate->translate('Departamento', $_SESSION['user_lang']); ?>">
                                                        ...
                                                        <div class="form-group to_validation">
                                                            ...
                                                            <textarea class="form-control to_validations" id="description"  name="description" placeholder="<?php echo $translate->translate('Descrição', $_SESSION['user_lang']); ?>" ></textarea>
        ...
        if (in_array("department_view", $privilege_types)) {
            ?>
            <script src="/libs/v1/admin/js/general/departments/lists/departments.min.js"></script>
            <?php
        }
        ?>
        <?php
        if (in_array("department_create", $privilege_types)) {
            ...
            <script src="/libs/v1/admin/js/general/departments/create/department.js"></script>
            <?php
        }
        ?>
