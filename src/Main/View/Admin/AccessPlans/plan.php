                                        ...
                                        <form style="margin: 10px;" role="form" name="form_access_plan" id="form_access_plan">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 to_validation">
                                                    <div class="form-group">
                                                        <label for="nTokens">
                                                            <?php echo $translate->translate('Número de Tokens', $_SESSION['user_lang']); ?> *
                                                        </label>
                                                        <input <?php echo $edit; ?> type="text" class="form-control to_validations" id="nTokens" name="nTokens" placeholder="<?php echo $translate->translate('Número de Tokens', $_SESSION['user_lang']); ?>" inputmode="numeric" autocomplete="off" value="<?php echo $access_plan->getNumber_tokens(); ?>">
                                                        <div id="to_validation_blank_nTokens" style="display: none;" class="to_blank"><span><?php echo $translate->translate('Não é permitido campo em branco', $_SESSION['user_lang']); ?>!</span></div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12 to_validation">
                                                    <div class="form-group">
                                                        <label for="nScripts">
                                                            <?php echo $translate->translate('Número de Roteiros', $_SESSION['user_lang']); ?> *
                                                        </label>
                                                        <input <?php echo $edit; ?> type="text" class="form-control to_validations" id="nScripts" name="nScripts" placeholder="<?php echo $translate->translate('Número de Roteiros', $_SESSION['user_lang']); ?>" inputmode="numeric" autocomplete="off" value="<?php echo $access_plan->getNumber_scripts(); ?>">
                                                        <div id="to_validation_blank_nScripts" style="display: none;" class="to_blank"><span><?php echo $translate->translate('Não é permitido campo em branco', $_SESSION['user_lang']); ?>!</span></div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12 to_validation">
                                                    <div class="form-group">
                                                        ...
                                                        <input <?php echo $edit; ?> type="text" class="form-control to_validations" id="nChannels" name="nChannels" placeholder="<?php echo $translate->translate('Número de Canais', $_SESSION['user_lang']); ?>" inputmode="numeric" autocomplete="off" value="<?php echo $access_plan->getNumber_channels(); ?>">
                                                        <div id="to_validation_blank_nChannels" style="display: none;" class="to_blank"><span><?php echo $translate->translate('Não é permitido campo em branco', $_SESSION['user_lang']); ?>!</span></div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12 to_validation">
                                                    <div class="form-group">
