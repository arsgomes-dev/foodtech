...
//Função para cadastro e atualização dos PRIVILÉGIOS
...
if (in_array("privileges_configuration", $privilege_types)) {
    ...
    if (!empty(array_filter($_POST)) && $_POST && !empty($_POST['title']) && isset($_POST['title'])) {
