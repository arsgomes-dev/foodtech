...
if (in_array("department_edit", $privilege_types)) {
    ...
    if (!empty(array_filter($_POST)) && $_POST && !empty($_POST['title']) && isset($_POST['title']) && !empty($_POST['description']) && isset($_POST['description'])) {
        ...
        $return = $department->setSaveQuery();
        if ($return == 1) {
