...
namespace Microfw\Src\Main\Common\Helpers\Public\PhpMailer;

use Microfw\Src\Main\Common\Entity\Public\Mailer;
use Microfw\Src\Main\Common\Helpers\Public\PhpMailer\SMTP;
use Microfw\Src\Main\Common\Helpers\Public\PhpMailer\PHPMailer;
    ...
    public function send() {
        ...
        try {
            ...
            if (is_array($this->email)) {
                ...
                $mail->addAddress($this->email, $this->nameMailer);
            }
            //reply
