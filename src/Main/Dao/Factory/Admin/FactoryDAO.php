...
namespace Microfw\Src\Main\Dao\Factory\Admin;

use Microfw\Src\Main\Dao\Database\Admin\MysqlDAO;
...
class FactoryDAO extends \stdClass {
   ...
   public static function query(
        ...
        switch ($db) {
            case 1:
                $obj = new MysqlDAO();
                return $obj::daoQuery($classA, $classB, $single, $limit, $offset, $order, $and_or, $less_equal, $greater_equal, $customWhere, $customWhereOr);
                break;
        }
    }
